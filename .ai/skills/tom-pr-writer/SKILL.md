...
**Automated tests** comes second. Check the branch for changes under `test/`; if there are none, say so plainly rather than implying coverage that does not exist. Match the level to what changed ([testing strategy](../../../docs/technical/layers.md#testing)):
