/// A line of prose where the results would be.
library;
...
/// One muted line standing in for the results, so no state leaves the panel
/// blank.
class SearchNoteWidget extends StatelessWidget {
  /// Creates a note saying [text].
  const SearchNoteWidget(this.text, {super.key});
