...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsFailure&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'SettingsFailure(description: $description)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String description)?  unavailable,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SettingsUnavailable() when unavailable != null:
return unavailable(_that.description);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String description)  unavailable,}) {final _that = this;
switch (_that) {
case SettingsUnavailable():
return unavailable(_that.description);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String description)?  unavailable,}) {final _that = this;
switch (_that) {
case SettingsUnavailable() when unavailable != null:
return unavailable(_that.description);case _:
  return null;
...
class SettingsUnavailable implements SettingsFailure {
  const SettingsUnavailable(this.description);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsUnavailable&&(identical(other.description, description) || other.description == description));
}
...
@override
String toString() {
  return 'SettingsFailure.unavailable(description: $description)';
}
