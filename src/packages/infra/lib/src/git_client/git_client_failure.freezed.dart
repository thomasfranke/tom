...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientFailure);
}
...
/// @nodoc
class $GitClientFailureCopyWith<$Res>  {
$GitClientFailureCopyWith(GitClientFailure _, $Res Function(GitClientFailure) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  executableNotFound,TResult Function( String path)?  notARepository,TResult Function( List<String> conflictedPaths)?  mergeConflict,TResult Function( String stderr)?  authenticationFailed,TResult Function( String stderr)?  pushRejected,TResult Function( String command,  Duration timeout)?  timedOut,TResult Function( String command,  int exitCode,  String stderr)?  commandFailed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case GitClientExecutableNotFound() when executableNotFound != null:
return executableNotFound();case GitClientNotARepository() when notARepository != null:
return notARepository(_that.path);case GitClientMergeConflict() when mergeConflict != null:
return mergeConflict(_that.conflictedPaths);case GitClientAuthenticationFailed() when authenticationFailed != null:
return authenticationFailed(_that.stderr);case GitClientPushRejected() when pushRejected != null:
return pushRejected(_that.stderr);case GitClientTimedOut() when timedOut != null:
return timedOut(_that.command,_that.timeout);case GitClientCommandFailed() when commandFailed != null:
return commandFailed(_that.command,_that.exitCode,_that.stderr);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  executableNotFound,required TResult Function( String path)  notARepository,required TResult Function( List<String> conflictedPaths)  mergeConflict,required TResult Function( String stderr)  authenticationFailed,required TResult Function( String stderr)  pushRejected,required TResult Function( String command,  Duration timeout)  timedOut,required TResult Function( String command,  int exitCode,  String stderr)  commandFailed,}) {final _that = this;
switch (_that) {
case GitClientExecutableNotFound():
return executableNotFound();case GitClientNotARepository():
return notARepository(_that.path);case GitClientMergeConflict():
return mergeConflict(_that.conflictedPaths);case GitClientAuthenticationFailed():
return authenticationFailed(_that.stderr);case GitClientPushRejected():
return pushRejected(_that.stderr);case GitClientTimedOut():
return timedOut(_that.command,_that.timeout);case GitClientCommandFailed():
return commandFailed(_that.command,_that.exitCode,_that.stderr);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  executableNotFound,TResult? Function( String path)?  notARepository,TResult? Function( List<String> conflictedPaths)?  mergeConflict,TResult? Function( String stderr)?  authenticationFailed,TResult? Function( String stderr)?  pushRejected,TResult? Function( String command,  Duration timeout)?  timedOut,TResult? Function( String command,  int exitCode,  String stderr)?  commandFailed,}) {final _that = this;
switch (_that) {
case GitClientExecutableNotFound() when executableNotFound != null:
return executableNotFound();case GitClientNotARepository() when notARepository != null:
return notARepository(_that.path);case GitClientMergeConflict() when mergeConflict != null:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientExecutableNotFound);
}
...
@override
String toString() {
  return 'GitClientFailure.executableNotFound()';
}
...
class GitClientNotARepository implements GitClientFailure {
  const GitClientNotARepository(this.path);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientNotARepository&&(identical(other.path, path) || other.path == path));
}
...
@override
String toString() {
  return 'GitClientFailure.notARepository(path: $path)';
}
...
class GitClientMergeConflict implements GitClientFailure {
  const GitClientMergeConflict(final  List<String> conflictedPaths): _conflictedPaths = conflictedPaths;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientMergeConflict&&const DeepCollectionEquality().equals(other._conflictedPaths, _conflictedPaths));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_conflictedPaths));

@override
String toString() {
  return 'GitClientFailure.mergeConflict(conflictedPaths: $conflictedPaths)';
}
...
/// Create a copy of GitClientFailure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? conflictedPaths = null,}) {
...
class GitClientAuthenticationFailed implements GitClientFailure {
  const GitClientAuthenticationFailed(this.stderr);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientAuthenticationFailed&&(identical(other.stderr, stderr) || other.stderr == stderr));
}
...
@override
String toString() {
  return 'GitClientFailure.authenticationFailed(stderr: $stderr)';
}
...
class GitClientPushRejected implements GitClientFailure {
  const GitClientPushRejected(this.stderr);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientPushRejected&&(identical(other.stderr, stderr) || other.stderr == stderr));
}
...
@override
String toString() {
  return 'GitClientFailure.pushRejected(stderr: $stderr)';
}
...
class GitClientTimedOut implements GitClientFailure {
  const GitClientTimedOut(this.command, this.timeout);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientTimedOut&&(identical(other.command, command) || other.command == command)&&(identical(other.timeout, timeout) || other.timeout == timeout));
}


@override
int get hashCode => Object.hash(runtimeType,command,timeout);

@override
String toString() {
  return 'GitClientFailure.timedOut(command: $command, timeout: $timeout)';
}
...
/// Create a copy of GitClientFailure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? command = null,Object? timeout = null,}) {
...
class GitClientCommandFailed implements GitClientFailure {
  const GitClientCommandFailed(this.command, this.exitCode, this.stderr);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GitClientCommandFailed&&(identical(other.command, command) || other.command == command)&&(identical(other.exitCode, exitCode) || other.exitCode == exitCode)&&(identical(other.stderr, stderr) || other.stderr == stderr));
}


@override
int get hashCode => Object.hash(runtimeType,command,exitCode,stderr);

@override
String toString() {
  return 'GitClientFailure.commandFailed(command: $command, exitCode: $exitCode, stderr: $stderr)';
}
...
@useResult
$Res call({
 String command, int exitCode, String stderr
});
...
/// Create a copy of GitClientFailure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? command = null,Object? exitCode = null,Object? stderr = null,}) {
