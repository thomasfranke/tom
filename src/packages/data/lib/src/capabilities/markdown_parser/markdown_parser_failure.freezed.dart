...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarkdownParserFailure&&(identical(other.description, description) || other.description == description)&&(identical(other.cause, cause) || other.cause == cause));
}
...
@override
String toString() {
  return 'MarkdownParserFailure(description: $description, cause: $cause)';
}
...
class MarkdownParserFailed implements MarkdownParserFailure {
  const MarkdownParserFailed(this.description, {this.cause});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarkdownParserFailed&&(identical(other.description, description) || other.description == description)&&(identical(other.cause, cause) || other.cause == cause));
}
...
@override
String toString() {
  return 'MarkdownParserFailure.failed(description: $description, cause: $cause)';
}
