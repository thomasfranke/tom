...
/// travel together, and an offset without its instant means nothing.
///
...
@freezed
abstract class CommitDate with _$CommitDate {
  /// Creates a commit date.
  const factory CommitDate({
