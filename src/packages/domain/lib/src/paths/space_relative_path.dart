...
/// git speaks [RepoRelativePath]. Two types rather than one `String` because
...
/// and `Space` is the only place allowed to convert between them.
///
/// An `extension type` rather than a Freezed class, for the same reason as
/// [RepoRelativePath]: a single-field wrapper has nothing to gain from a
/// generated `copyWith` ([Decision
/// 16](../../../../../../docs/technical/decisions/016-freezed-is-mandatory-for-immutable-data.md)).
extension type const SpaceRelativePath._(String value) {
  ...
  factory SpaceRelativePath(String value) =>
      tryParse(value) ??
  ...
  static SpaceRelativePath? tryParse(String value) =>
      isRelativePathSyntax(value) ? SpaceRelativePath._(value) : null;
