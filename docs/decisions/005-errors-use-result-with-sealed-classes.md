...
## Decision
Keep the Result/Either pattern, implemented with Dart 3 sealed classes + pattern matching (`Result<T>` / `AppFailure`, see [../architecture/04-error-model.md](../architecture/04-error-model.md)). Do not adopt `dartz`.
