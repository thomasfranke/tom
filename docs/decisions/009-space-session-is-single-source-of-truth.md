...
How that plays out — derivation with `select`, what stays panel-local, one session per space — is in [../architecture/06-presentation.md](../architecture/presentation/state.md).
