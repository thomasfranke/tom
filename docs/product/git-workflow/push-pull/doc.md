...
- **While a push stands refused, that banner is the column**: the message box and the commit button give way to it rather than competing for a panel that is already sharing its height. They come back when it clears, with whatever was typed still in them.
