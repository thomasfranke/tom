...
The source of truth for what each feature must do — non-technical, maintained by stakeholders, and what an implementation should be checked against. [`about.md`](../about.md) is the "why" (the bet, principles, personas, non-goals); this is the "what", one folder per feature. How it is built is [`technical/`](../technical/README.md), which links here and never restates a rule from it.

## Shape

```
docs/product/<group>/<feature>/
