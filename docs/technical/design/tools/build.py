"""Builds every desktop wireframe into the product it belongs to (../../../product/<feature>/mocks/).

    python3 docs/technical/design/tools/build.py
...
PRODUCTS = os.path.join(os.path.dirname(os.path.dirname(DESIGN)), "product")  # every screen lives next to the product's doc.md
H = 560
