...
- The preview can be assembled block by block ([runtime/preview.md](../runtime/preview.md)), which is what the rendered diff needs. The document's link reference map travels with the blocks.
