...
- **Follow the patterns.** The canonical code templates sit beside the layer they govern — [error handling](docs/architecture/core/error-handling.md), [dependency injection](docs/architecture/presentation/dependency-injection.md), [extension modules](docs/architecture/presentation/extension-modules.md). New code follows them.
